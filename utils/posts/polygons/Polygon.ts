...
export default class Polygon extends Shape<SVGPolygonElement> {
    ...
    public createElement(processes: { type: "mult" | "add"; matrix: RefMaybe<number>[][] }[]) {
        this.element = document.createElementNS(Polygon.SVGNS, "polygon");
    ...
    public changeElement(processes: { type: "mult" | "add"; matrix: RefMaybe<number>[][] }[]) {
        ...
        if (this.element) {
            ...
            this.element.setAttribute("class", "polygon");
        }
