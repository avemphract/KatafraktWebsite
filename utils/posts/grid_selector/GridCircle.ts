...
export default class GridCircle extends GridSvg {
    ...
    drawCircle() {
        ...
        for (let x = 0, y = Math.round(this.moveableElement.radius); y > x; x++) {
            ...
            for (let i = y; i >= x; i--) {
                this.ifExistAdd(tempPoint, this.moveableElement.node!.x + x, this.moveableElement.node!.y + i);
                this.ifExistAdd(tempPoint, this.moveableElement.node!.x + i, this.moveableElement.node!.y + x);
                this.ifExistAdd(tempPoint, this.moveableElement.node!.x + x, this.moveableElement.node!.y - i);
                this.ifExistAdd(tempPoint, this.moveableElement.node!.x + i, this.moveableElement.node!.y - x);
                this.ifExistAdd(tempPoint, this.moveableElement.node!.x - x, this.moveableElement.node!.y - i);
                this.ifExistAdd(tempPoint, this.moveableElement.node!.x - i, this.moveableElement.node!.y - x);
